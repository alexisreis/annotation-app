...
--
-- Host: localhost:3306
-- Generation Time: Aug 09, 2022 at 09:01 AM
...
-- Database: `test_flask`
--
CREATE DATABASE IF NOT EXISTS `annotation-app` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `annotation-app`;
